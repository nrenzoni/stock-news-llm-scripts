...
class EmbeddingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CalculateEmbeddings = channel.unary_unary(
                '/embedding.EmbeddingService/CalculateEmbeddings',
        ...
        self.Echo = channel.unary_unary(
                '/embedding.EmbeddingService/Echo',
                request_serializer=embedding__pb2.EmbeddingRequest.SerializeToString,
                response_deserializer=embedding__pb2.EmbeddingRequest.FromString,
                _registered_method=True)
...
def add_EmbeddingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Echo': grpc.unary_unary_rpc_method_handler(
                    servicer.Echo,
                    request_deserializer=embedding__pb2.EmbeddingRequest.FromString,
                    response_serializer=embedding__pb2.EmbeddingRequest.SerializeToString,
            ),
    }
...
class EmbeddingService(object):
    ...
    def Echo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/embedding.EmbeddingService/Echo',
            embedding__pb2.EmbeddingRequest.SerializeToString,
            embedding__pb2.EmbeddingRequest.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
